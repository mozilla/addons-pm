...
describe('serverSWR', () => {
  ...
  it('should return stale data first, followed by fresh data', async () => {
    ...
    // Based on the time being newer than now, the cache should be updated with a new timestampe to prevent
    // premature re-fetches as well as providing the new data.

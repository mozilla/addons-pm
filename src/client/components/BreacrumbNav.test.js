...
describe('BreadcrumbNav', () => {
  ...
  it('should render engineer', () => {
    ...
    expect(wrapper.find('LinkContainer[to="/2018/Q3/willdurand/"]').length).toBe(1);
  });
  ...
  it('should render primary', () => {
    ...
    expect(wrapper.find('LinkContainer[to="/2018/"]').length).toBe(1);
    expect(wrapper.find('LinkContainer[to="/2018/Q3/"]').length).toBe(1);
    expect(wrapper.find('LinkContainer[to="/2018/Q3/primary/"]').length).toBe(1);
  });
  ...
  it('should render no quarter if missing', () => {
    ...
    expect(wrapper.find('LinkContainer[to="/"]').length).toBe(1);
    expect(wrapper.find('LinkContainer[to="/2018/"]').length).toBe(1);
    expect(wrapper.find('LinkContainer[to="/2018/"]').childAt(0).prop('active')).toBe(true);
  ...
  it('should render no year if missing', () => {
    ...
    expect(wrapper.find('LinkContainer[to="/"]').length).toBe(1);
    expect(wrapper.find('LinkContainer[to="/"]').childAt(0).prop('active')).toBe(true);
